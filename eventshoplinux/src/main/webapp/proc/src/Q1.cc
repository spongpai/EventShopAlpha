...
int main()
{
	EmageIngestor ds13("D://BOPT//NextGenUI//EventShop//EventShop//releases//releaseDec//eventshoplinux//src//main//webapp//temp//ds13_null");
	int rows0 = 75;
	int cols0 = 58;
	...
	FilterCondition fcond0(mask0, LT, 1, 1, 1407513186641, 9223372036854775807, true, 0, 100);
	Filter Q1(ds13, fcond0);
